# Proyecto 1 – Transformación Digital de EcoMerc usando IA

## Índice del Proyecto
Este repositorio contiene la documentación completa del proyecto de transformación digital de EcoMerc, un supermercado pequeño, integrando tecnologías de Inteligencia Artificial (IA) en planta y negocio.
...
- Optimice la gestión de inventario y reposición en planta (OT) mediante IoT, sensores, RFID y Machine Learning.  
- Mejore la gestión de información y atención al cliente en negocio (IT) mediante ERP, CRM, análisis de datos, chatbots, web/app y marketing digital.  
- Permita decisiones estratégicas basadas en datos, reduciendo errores, aumentando eficiencia y mejorando la competitividad.
...
- Inventario optimizado y en tiempo real  
- Reducción de roturas de stock y exceso de inventario  
- Automatización de tareas operativas y administrativas  
- Mejora en la experiencia del cliente y fidelización  
- Competitividad reforzada frente a supermercados tradicionales
